...
settings["SAM"] = T{ };
settings["SAM"]["gambits"] = T{ };
settings["SAM"]["gambits"][1] = T{ };
...
settings["SAM"]["gambits"][1]["on"] = true;
settings["SAM"]["gambits"][1]["label"] = "Gambit 1";
settings["SAM"]["gambits"][1]["condition_count"] = 0;
settings["SAM"]["gambits"][1]["selected"] = "hasso";
settings["SAM"]["count"] = 1;
